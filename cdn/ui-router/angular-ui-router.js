...
! function(t, e) {
    ...
    function vt(t) {
        ...
        return le(a, function(e, i) {
            if (i = i || "$default", Zt(e) && (e = {
                    component: e
                }), e = he({}, e), Zn(r, e) && Zn(n, e)) throw new Error("Cannot combine: " + r.join("|") + " with: " + n.join("|") + " in stateview: '" + i + "@" + t.name + "'");
    ...
    var Ze = function() {
        ...
        rr = function() {
            ...
            return t.prototype.getPolicy = function(t) {
                var e = this.policy || {},
                    r = t && t.resolvePolicy || {};
                return {
                    when: e.when || r.when || er.when,
                    async: e.async || r.async || er.async
                }
        ...
        sr = function() {
            ...
            return t.prototype.getTokens = function() {
                ...
                var e = this,
                    r = this.findNode(t),
                    n = (tr.subPath(this._path, function(t) {
                        return t === r
    ...
    var Lr = function() {
        ...
        Mr = function() {
            ...
            return t.prototype._rootViewContext = function(t) {
                ...
                return e.filter(function(e) {
                    ...
                    }).length && Me.traceViewServiceUIViewEvent("!!!! duplicate uiView named:", t), e.push(t), this.sync(),
                    function() {
        ...
        Kr = ["deferIntercept", "listen", "sync", "match"],
        Yr = function() {
            function t(t, e) {
            ...
            }, t.prototype.dispose = function() {}, t.prototype.sync = function(t) {}, t.prototype.listen = function(t) {}, t.prototype.deferIntercept = function(t) {}, t.prototype.match = function(t) {}, t.locationServiceStub = Gr(Wr), t.locationConfigStub = Gr(zr), t
        }(),
        Zr = 0,
        Xr = function() {
            function t(t, e) {
        ...
        kn = function() {
            ...
            return Object.defineProperty(e.prototype, "transition", {
                ...
                var n = this,
                    i = tr.makeTargetState(this.router.stateRegistry, t),
                ...
                var n = this.getCurrentPath(),
                    i = tr.makeTargetState(this.router.stateRegistry, n);
        ...
        zn = ht("vanilla.hashBangLocation", !1, Nn, Wn),
    ...
    var si = It.module("ui.router.init", []),
        ci = It.module("ui.router.util", ["ng", "ui.router.init"]),
        fi = It.module("ui.router.router", ["ui.router.util"]),
        li = It.module("ui.router.state", ["ui.router.router", "ui.router.util", "ui.router.angular1"]),
        hi = It.module("ui.router", ["ui.router.init", "ui.router.state", "ui.router.angular1"]),
        pi = (It.module("ui.router.compat", ["ui.router"]), null);
    ...
    _t.$inject = ["$rootScope"], si.provider("$uiRouter", yt), fi.provider("$urlRouter", ["$uiRouterProvider", function(t) {
        ...
        return Me
    }), hi.run(_t), ci.run(["$urlMatcherFactory", function(t) {}]), li.run(["$state", function(t) {}]), fi.run(["$urlRouter", function(t) {}]), si.run(gt);
            ...
            s = {
                ...
                compile: function(e, c, f) {
                    return function(e, c, l) {
                        ...
                        Me.traceUIViewEvent("Linking", R), c.data("$uiView", {
                            $uiView: R
    ...
    var wi = "function" == typeof It.module("ui.router").component,
        $i = 0;
